...
install-unix:
	...
	@eval "ln -s $(CURDIR)/luna_pinyin.custom.yaml $(INSTALL_DIR)/luna_pinyin_simp.custom.yaml"
...
install-win:
	...
	@eval "cp $(CURDIR)/luna_pinyin.custom.yaml $(INSTALL_DIR)\luna_pinyin_simp.custom.yaml"
